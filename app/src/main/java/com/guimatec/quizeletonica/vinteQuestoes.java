...
public class vinteQuestoes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String minhaUrl="http://www.json-generator.com/api/json/get/cwevMYlzuG?indent=2";
    ...
    private void criaAlerta() {
        ...
        alerta = new AlertDialog.Builder(com.guimatec.quizeletonica.vinteQuestoes.this);
        alerta.setTitle("Fim das Perguntas");
        alerta.setMessage("Você acertou "+ acertos +" questões de 20");
        ...
        alerta.setNegativeButton("Sair", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(vinteQuestoes.this,MainActivity.class));
            }
        });
