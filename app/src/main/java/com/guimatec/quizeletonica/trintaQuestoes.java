...
public class trintaQuestoes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String minhaUrl="http://www.json-generator.com/api/json/get/cvqBYmqyZK?indent=2";
    ...
    private void criaAlerta() {
        ...
        alerta = new AlertDialog.Builder(trintaQuestoes.this);
        alerta.setTitle("Fim das Perguntas");
        alerta.setMessage("Você acertou "+ acertos +" questões de 30");
        ...
        alerta.setNegativeButton("Sair", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(trintaQuestoes.this,MainActivity.class));
            }
        });
